...
class Start(smach.State):
    def __init__(self):
        ...
        # self.launch = roslaunch.parent.ROSLaunchParent(uuid,["/home/tiago/God-Watcher/workspace/Finalproject/src/god_states_machine/launch/states_launch/speech_manipulation.launch"])
...
class Learn_operator(smach.State):
    def __init__(self):
        ...
        # uuid = roslaunch.rlutil.get_or_generate_uuid(None, False)
        # roslaunch.configure_logging(uuid)
        # self.launch = roslaunch.parent.ROSLaunchParent(uuid, ["/home/tiago/God-Watcher/workspace/Finalproject/src/god_states_machine/launch/states_launch/learn.launch"])
    ...
    def execute(self, userdata):
        ...
        if(self.onpose == 0):
            ...
            if(self.follow_count >20 or self.end_signal == 'bring'):
                ...
                rospy.loginfo('Executing state follow')
                return 'following'
            #     if(self.onpose != 0 and (self.end_signal == 'yes')):
            #         # userdata.next_desired_pose = self.desired_pose
            #         speak_client("following")
            #         return 'following'
            #     elif(self.onpose == 0 and (self.end_signal == 'yes')):
